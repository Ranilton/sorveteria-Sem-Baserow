...
async function fetchData() {
  try {
    ...
    const records = data.results.filter(record => record.Ativos || record.Ativos_2);
                    ...
                    <div class="cardG">
                        ...
                        <div class="cards">
                            ...
                            <div id="card_B" class="card_B">
                                ...
                                <img id="imagem_B" class="imgcard" src="${record.Imagens_2}" alt="Imagem de ${record.Nomes_2}">
                                <div class="cardValor">
                                    <div class="p">
